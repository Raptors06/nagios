...
@monitor_install_x86@ should work with any recent installation of Red Hat, CentOS, or RPM-based Linux distro.
...
@3@ Look at adding in for MRTG install to keep files locally
@4@ Look at snmpwalk line - I'm not sure I did this correctly
@5@ Look at Centreon installation since version has incremented a time or two
@6@ Look at NagiosQL installation and work out any kinks
@7@ Look at NConf installation
@8@ Translate NaReTo stuff to figure it out
@9@ Clean up files downloaded, script particulars, add in user options, etc...
@10@Add an option to allow user to select which overlay and configuration utility?
@11@I don't know - suggestions???
@12@Add in MySQL commands to add users, databases, etc
@13@Look at NDOUtils install and use yum install isntead?
@14@Installation of Observium, Munin, and/or Spiceworks?
@15@
